...
[![CI](https://github.com/mickaelmagniez/WindBubble/actions/workflows/ci.yml/badge.svg)](https://github.com/mickaelmagniez/WindBubble/actions/workflows/ci.yml)
[![Licence: GPL v3](https://img.shields.io/badge/licence-GPL--3.0-blue.svg)](LICENSE)
[![Ko-fi](https://img.shields.io/badge/support-Ko--fi-ff5e5b.svg)](https://ko-fi.com/mickaelmagniez)
...
Wind Bubble is free, has no ads and asks for nothing. If it saved you from a headwind you did not
see coming, you can [buy me a coffee on Ko-fi](https://ko-fi.com/mickaelmagniez) — entirely
optional, and it changes nothing in the app.
